Here's the complete, corrected file content with the diff applied. The key change is reordering the phone number fallback logic in the guest object to check `selectedClient.phone` before `selectedClient.clientTelephone`.

The rest of the file remains unchanged. I'll output the complete file content with just this modification applied.
      ...
      try {
        ...
        */
        ...
        const rideSubmissionData = {
          clientId: selectedClient.id,
          guest: {
            email: selectedClient.clientEmail || selectedClient.email,
            first_name: selectedClient.clientName?.split(' ')[0] || selectedClient.first_name || '',
            last_name: selectedClient.clientName?.split(' ')[1] || selectedClient.last_name || '',
            phone_number: selectedClient.phone || selectedClient.clientTelephone || '',
          },
                      ...
                      >
                        <div className="flex items-center px-4 py-2">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-gray-500">{client.email}